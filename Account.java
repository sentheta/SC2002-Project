...
/**
 * Represents an account that all Employees (Staff, Manager, Admin) {@link scse_FOODIE.Employee} has, to log in to the system.
 * 
 */
public class Account implements Serializable{
	...
	/**
	 * This method allows Employees {@link scse_FOODIE.Employee} to change their passwords.
